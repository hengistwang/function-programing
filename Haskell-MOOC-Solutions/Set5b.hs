...
isOrdered (Node v l Empty) = allValues (< v) l && isOrdered l
isOrdered (Node v Empty r) = allValues (> v) r && isOrdered r
...
set path _ (Node val Empty Empty) = Node val Empty Empty
